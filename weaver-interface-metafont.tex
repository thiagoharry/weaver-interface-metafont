...
struct pen_variable{
  ...
  float width, height; // Altura, largura
};
@
\fimcodigo
...
As variáveis \monoespaco{width} e \monoespaco{height} armazenam a
largura e altura.
...
variável de caneta e multiplicar a sua matriz de transformação:
