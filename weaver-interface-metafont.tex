...
\monoespaco{floor},  \monoespaco{uniformdeviate}.
...
1) Se a expressão tem um único token diferente
de \monoespaco{normaldeviate}, ela é um único Átomo Numérico. Esse é o
caso mais comum, então vamos tratá-lo primeiro e mais rapidamente, sem
a necessidade de chamar mais funções recursivamente. Apenas copiamos o
conteúdo presente referenciado pelo token para o lugar reservado para
colocar o resultado da expressão:
...
operador numérico seguido por primário numérico (multiplicação
escalar). Neste caso, obtemos o resultado da operação fazendo a
multiplicação da variável pelo escalar:
