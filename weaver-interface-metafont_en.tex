...
\iniciocodigo
@<METAFONT: Symbolic Token Definition@>+=
#define TYPE_ROTATED  38 // Symbolic token 'rotated'
#define TYPE_SCALED   39 // Symbolic token 'scaled'
#define TYPE_SHIFTED  40 // Symbolic token 'shifted'
#define TYPE_SLANTED  41 // Symbolic token 'slanted'
#define TYPE_XSCALED  42 // Symbolic token 'xscaled'
#define TYPE_YSCALED  43 // Symbolic token 'yscaled'
#define TYPE_ZSCALED  44 // Symbolic token 'zscaled'
@
\fimcodigo
...
\iniciocodigo
@<METAFONT: Symbolic Token Definition@>+=
#define TYPE_XPART  45 // Symbolic token 'xpart'
#define TYPE_YPART  46 // Symbolic token 'ypart'
#define TYPE_ANGLE  47 // Symbolic token 'angle'
@
\fimcodigo
