...
less space. For example, parenthesis and commas. We can represent them
...
5) If the next character is a parenthesis or a comma, the next token
will be symbolic and composed by that single character.
...
\iniciocodigo
@<METAFONT: Symbolic Token Definition@>=
#define TYPE_END             7 // The symbolic token 'end' or 'dump'
@
\fimcodigo
