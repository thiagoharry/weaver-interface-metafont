...
5) Se o próximo caractere for um parêntese ou uma vírgula, então o
próximo token será um token simbólico formado por este único
caractere.
...
\iniciocodigo
@<METAFONT: Definição de Token Simbólico@>=
#define TYPE_END             7 // O token simbólico 'end' ou 'dump'
@
\fimcodigo
